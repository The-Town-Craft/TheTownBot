...
public class SubtractActivityPointsCommand extends DiscordCommand {
    ...
    public void execute(CommandEvent.Discord event) {
        ...
        ActivityManager.PLAYER_ACTIVITY_MAP.computeIfAbsent(uuid, k -> (long) amount);
        ...
        event.getChannel().sendMessage(":white_check_mark: **Success**! Subtracted " + amount + " Activity Points from " + player.getName() + "! (new value is " + newVal + ")").queue();
    }
    ...
    public String getDescription() {
        return "Subtract activity points from the player!";
    }
